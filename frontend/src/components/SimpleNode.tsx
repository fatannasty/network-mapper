...
const nodeStyle: Record<string, NodeStyle> = {
  ...
  'velocloud-edge': { border: 'border-fuchsia-400/70', bg: 'bg-gradient-to-br from-fuchsia-500/30 via-fuchsia-500/10 to-fuchsia-500/5', glow: 'shadow-fuchsia-500/30', iconBg: 'bg-fuchsia-500/25', iconText: 'text-fuchsia-200', bar: 'bg-fuchsia-400' },
