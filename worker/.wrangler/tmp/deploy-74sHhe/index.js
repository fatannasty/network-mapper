    ...
    try {
      ...
      if (url.pathname === "/api/scan" && request.method === "POST") {
        ...
        const locationData = {
          ...
          scannedAt: scannedAt || (/* @__PURE__ */ new Date()).toISOString(),
          devices,
      ...
      if (url.pathname === "/api/catc/scan" && request.method === "POST") {
        ...
        try {
          ...
          const mapType = /* @__PURE__ */ __name((d) => {
          ...
          const mapDevice = /* @__PURE__ */ __name((d) => ({
          ...
          const saveLocation = /* @__PURE__ */ __name(async (locId, locName, devs) => {
            const locationData = {
              name: locName,
