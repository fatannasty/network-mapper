(() => {
  ...
  const SWITCH_MODELS = {
    'C9200-24P':     { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9200-48P':     { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9200-24T':     { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9200-48T':     { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9200CX-12-2X2G': { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9200CX-8P-2X2G': { svg: 'icons/c9200-hq.svg', type: 'access-switch' },
    'C9300-24T':     { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300-48T':     { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300-24U':     { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300-48U':     { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300L-24P':    { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300L-48P':    { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300X-12Y':    { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300X-24Y':    { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9300X-24T':    { svg: 'icons/c9300-hq.svg', type: 'switch' },
    'C9400-7S':      { svg: 'icons/c9500-hq.svg', type: 'core-switch' },
    'C9400-10S':     { svg: 'icons/c9500-hq.svg', type: 'core-switch' },
    'C9500-12Q':     { svg: 'icons/c9500-hq.svg', type: 'core-switch' },
    'C9500-24Y4C':   { svg: 'icons/c9500-hq.svg', type: 'core-switch' },
    'C9500-48Y4C':   { svg: 'icons/c9500-hq.svg', type: 'core-switch' },
    'IE-3300-8P2S':  { svg: 'icons/c9200-hq.svg', type: 'switch' },
    'IE-3400-8P2S-E':{ svg: 'icons/c9200-hq.svg', type: 'switch' },
    'IEM-3300-14T2S':{ svg: 'icons/c9200-hq.svg', type: 'switch' },
    'IEM-3300-16P':  { svg: 'icons/c9200-hq.svg', type: 'switch' },
    'IEM-3300-8S':   { svg: 'icons/c9200-hq.svg', type: 'switch' },
  };
