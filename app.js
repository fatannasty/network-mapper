(() => {
  ...
  const DEVICE_COLORS = {
    ...
    accesspoint:      { fill: '#3b82f6', stroke: '#2563eb', icon: 'AP', svg: 'icons/meraki-mr46.svg' },
  ...
  const SWITCH_MODELS = {
    ...
    'C9200CX-12-2X2G': { svg: 'icons/C9200CX-12-2X2G.png', type: 'access-switch' },
    'C9200CX-8P-2X2G': { svg: 'icons/C9200CX-8P-2X2G.png', type: 'access-switch' },
